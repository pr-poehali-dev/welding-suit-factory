    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: "1px solid rgba(245,124,0,0.2)" }}
        >
          <h3
        ...
        <div className="px-6 py-5">
          {sent ? (
            <div className="flex flex-col items-center py-8 text-center">
              ...
              <div className="text-sm mb-1" style={{ color: "#8a9ab5" }}>
                Сумма заказа:{" "}
                <span style={{ color: "#f57c00", fontWeight: "bold" }}>
                  {totalPrice.toLocaleString("ru-RU")} ₽
                </span>
              </div>
              <div className="text-sm" style={{ color: "#8a9ab5" }}>
            ...
            <div className="space-y-4">
              {/* Краткий итог */}
              <div
                className="p-3 rounded text-sm flex justify-between"
                style={{
                  background: "#0d1117",
              ...
              >
                <span style={{ color: "#8a9ab5" }}>
                  {cartLength} позиц. · {cartQtySum} шт
                </span>
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    background: "#0d1117",
                    border: `1px solid ${mError ? "rgba(248,113,113,0.5)" : "rgba(245,124,0,0.25)"}`,
                    color: "#e8e0d0",
                    outline: "none",
                  }}
                />
